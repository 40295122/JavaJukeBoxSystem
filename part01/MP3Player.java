...
public class MP3Player implements iPlayer {
	...
	/**
	 *  The getTuneInfo method returns an string array containing all of the tunes data
	 */
	...
	/**
	 *  The getTuneInfo(String artist) method returns an string array containing all of the tune data of a specified artist
	 *  Parameter String artist specifies the artist
	 */
	...
	/**
	 * The getTuneInfo(Genre gen) method returns an string array containing all of the tune data of a specified genre
	 *  Parameter Genre gen specifies the genre
	 */
